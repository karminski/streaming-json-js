...
var banner = 
`/*!
 * ${pkg.name} ${version} (https://github.com/karminski/streaming-json)
 * API https://github.com/karminski/streaming-json/blob/master/doc/api.md
 * Copyright 2017-${(new Date).getFullYear()} karminski. All Rights Reserved
